...
(function (mod) {
    ...
    function Completion(cm, options) {
        ...
        this.config = cm.getOption('hintOptions');
    ...
    Completion.prototype = {
        close: function () {
            ...
            this.config.wizardService.active = false;
            this.config.wizardService.html = false;
        ...
        pickWizard: function (data, i) {
            var completion = data.list[i];
            CodeMirror.signal(data, "pick", completion);
            this.close();
            this.config.wizardService.launchWizard(
                    this,
                    getText(completion),
                    completion,
                    data
    ...
    Widget.prototype = {
        ...
        pickWizard: function () {
            this.completion.pickWizard(this.data, this.selectedHint);
        },
